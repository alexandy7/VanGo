...
export default function CaixaVisualizacaoCliente({responsavel, horario, endereco, endereco2, evento}) {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.divpincel}>
                <TouchableOpacity onPress={evento}>
                    <Ionicons name="chatbubbles-sharp" size={20} color='#F7770D' style={styles.iconechat}/>
                </TouchableOpacity>
            </View>
