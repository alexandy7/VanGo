...
export default function ConfigDoCliente() {

    const navigation = useNavigation();

    const irPerfil = () => {
        navigation.navigate('PerfilCliente')
        // lembra de trocar o coiso das navegações :o
    }
        ...
        <View style= {styles.main}>
            ...
            <View style={styles.card}>
                ...
                <Lista icone='notifications' titulo="Notificações" evento={()=>{
                    navigation.navigate('')
                    // COLOCAR O DIRECIONAMENTO PARA AS NOTIFICAÇÕES DO CLIENTE
                }}></Lista>
            </View>
            ...
            <View style={styles.card}>
                <Lista icone='eye'titulo="Alterar motorista"></Lista>
                <Lista icone='cloudy-night' titulo="Visualizar código"></Lista>
