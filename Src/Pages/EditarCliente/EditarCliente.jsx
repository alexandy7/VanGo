...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Image, FlatList, KeyboardAvoidingView } from "react-native";
...
import ListEscolas from "../../PagesMotorista/CadastroVeiculo/CadastroVeiculo";
    ...
    async function Editar() {
        ...
        try {
            ...
            const data = {
                ...
                Endereco_cliente: user.endereco_cliente,
                Foto_cliente: user.foto_cliente,
                Endereco_reserva: user.endereco_reserva,
                Responsavel_cliente: user.responsavel_cliente,
                Senha_cliente: senha
            };
